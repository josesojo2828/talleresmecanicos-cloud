...
CREATE TABLE "works" (
    ...
    "workshop_client_id" TEXT,

    CONSTRAINT "works_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "workshop_clients" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "phone" TEXT,
    "email" TEXT,
    ...
    CONSTRAINT "workshop_clients_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "works_workshop_client_id_idx" ON "works"("workshop_client_id");

-- CreateIndex
CREATE INDEX "works_public_id_idx" ON "works"("public_id");

-- CreateIndex
CREATE INDEX "workshop_clients_workshop_id_idx" ON "workshop_clients"("workshop_id");

-- CreateIndex
CREATE INDEX "workshop_clients_user_id_idx" ON "workshop_clients"("user_id");
...
-- AddForeignKey
ALTER TABLE "works" ADD CONSTRAINT "works_workshop_client_id_fkey" FOREIGN KEY ("workshop_client_id") REFERENCES "workshop_clients"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "workshop_clients" ADD CONSTRAINT "workshop_clients_workshop_id_fkey" FOREIGN KEY ("workshop_id") REFERENCES "workshops"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "workshop_clients" ADD CONSTRAINT "workshop_clients_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
