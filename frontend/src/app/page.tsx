...
export const metadata: Metadata = {
    ...
    description: "La plataforma líder para encontrar talleres mecánicos verificados. Compara precios, lee opiniones y contacta con expertos en México, Argentina, Chile y más.",
