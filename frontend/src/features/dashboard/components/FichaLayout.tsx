...
import { 
    Activity, Database, Settings, Info, 
    Calendar, Clock, Wrench, Shield,
    User as UserIcon, MapPin, Globe, LayoutGrid
} from 'lucide-react';
...
export const FichaLayout: React.FC<FichaLayoutProps> = ({
    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            {/* 1. Header Area: More compact glassmorphism */}
            ...
            {/* 2. Tabs Navigation: More compact */}
            ...
            {/* 3. Content Area: Tight glass */}
            <div className="bg-white/30 backdrop-blur-sm border border-white/20 p-6 rounded-[2rem] shadow-sm relative overflow-hidden">
