                    ...
                    {offerings.map((item, idx) => (
                        ...
                        >
                            <div className="space-y-10 relative z-10">
                                ...
                                <Link href="/registro" className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-emerald-600 hover:text-slate-950 transition-colors">
